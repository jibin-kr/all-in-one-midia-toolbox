...
public class HelperMethods {
    ...
    private static FilesAdapter fladp;
    ...
    public static void transfer(File file) {
        try {
            String stringBuffer = Environment.getExternalStorageDirectory().getAbsolutePath() + "/"+classContext.getString(R.string.app_name)+ "/Saved Statuses/";

            final File destination = new File(stringBuffer + file.getName());
