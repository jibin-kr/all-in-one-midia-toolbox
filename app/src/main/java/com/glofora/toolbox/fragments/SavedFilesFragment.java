package com.glofora.toolbox.fragments;
...
import com.glofora.toolbox.Utls.Common;
import com.glofora.toolbox.Utls.ThumbnailUtils;
import com.glofora.toolbox.adapter.FilesAdapter;
...
import static com.glofora.toolbox.Utls.Common.APP_DIR;
...
public class SavedFilesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        APP_DIR= Environment.getExternalStorageDirectory().getAbsolutePath() + "/"+this.getString(R.string.app_name)+ "/Saved Statuses/";
