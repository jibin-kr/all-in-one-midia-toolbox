...
import com.glofora.whatstus.fragments.bwa.BWAFragment;
import com.glofora.whatstus.fragments.bwa.BWASplitterFragment;
import com.glofora.whatstus.fragments.wa.WAFragment;
import com.glofora.whatstus.fragments.wa.WASplitterFragment;
...
import static com.glofora.whatstus.Utls.Common.APP_DIR;
            ...
            builder.setPositiveButton("Yes", (dialog, which) -> {
                ...
                Needle.onBackgroundThread().execute(new UiRelatedProgressTask<String, Integer>() {
                    ...
                    protected String doWork() {
                        ...
                        File dir = new File(getString(R.string.file_split_path)+"/Whatstus Splitted Videos/");
                        if (dir.isDirectory()) {
                            ...
                            for (int i = 0; i < children.length; i++) {
                                ...
                                try {
                                    ...
                                    Utilities.DeletefilesFromMediaStore(getApplicationContext(), getString(R.string.file_split_path)+"Whatstus Splitted Videos/" + children[i]);
