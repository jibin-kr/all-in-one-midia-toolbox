...
import com.glofora.whatstustoolbox.Utls.HttpHandler;
import com.glofora.whatstustoolbox.Utls.NetworkUtil;
import com.glofora.whatstustoolbox.Utls.NotificationUtils;
import com.glofora.whatstustoolbox.Utls.Utilities;
import com.glofora.whatstustoolbox.adapter.PostsAdapter;
    ...
    public void downLoad(){
        if(!repostList.isEmpty()){
            ...
            for(String url:repostList.get(0).getImg_urls()) {
                ...
                if (!directory.endsWith("/Whatstus")) {
