package com.glofora.whatstustoolbox.fragments.wa;
...
import com.glofora.whatstustoolbox.Utls.Utilities;
...
import static com.glofora.whatstustoolbox.Utls.Utilities.CAMERA_REQUEST_VIDEO_TRIMMER;
import static com.glofora.whatstustoolbox.Utls.Utilities.REQUEST_STORAGE_READ_ACCESS_PERMISSION;
import static com.glofora.whatstustoolbox.Utls.Utilities.REQUEST_VIDEO_TRIMMER;


/**
 * A simple {@link Fragment} subclass.
 */
public class WASplitterFragment extends Fragment {
View splitterView;
...
// OnScrollListener
        ...
        rdBtnW.setText("Whatsapp");
        if(!Utilities.checkInstallation("com.whatsapp",getContext())){
        ...
        rdBtnW.setOnClickListener(v -> {
            if(Utilities.checkInstallation("com.whatsapp",getContext())) {
                ...
                Toast.makeText(getContext(), "WhatsApp Not Found on this Phone :(", Toast.LENGTH_SHORT).show();
                rdBtnC.setChecked(true);
                app = 101;
        ...
        rdBtnC.setOnClickListener(v -> onRadioButtonClicked(v));
