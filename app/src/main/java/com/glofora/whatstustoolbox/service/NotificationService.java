package com.glofora.whatstustoolbox.service;
...
public class NotificationService extends Service {
    ...
    public void onDestroy() {
        super.onDestroy();
        try {
            Intent intent = new Intent(this, Class.forName("com.glofora.whatstustoolbox.service.reciever.BootReceiver"));
    ...
    private void showImageStatusNotification() {
        ...
        try {
            notification.setContentTitle("Status Saver").setContentText("New Image Status, Refresh Now!").setContentIntent(PendingIntent.getActivity(this, 0, new Intent(this, Class.forName("com.glofora.whatstustoolbox.StatusSaverActivity")), 0)).setSmallIcon(R.drawable.notif).setShowWhen(true).setVibrate(new long[]{(long) 100, (long) 100, (long) 100, (long) 100}).setColor(ContextCompat.getColor(this, R.color.colorAccent));
    ...
    private void showVideoStatusNotification() {
        ...
        notification = new Builder(this);
        try {
            notification.setContentTitle("Status Saver").setContentText("New Video Status, Refresh Now!").setContentIntent(PendingIntent.getActivity(this, 1, new Intent(this, Class.forName("com.glofora.whatstustoolbox.StatusSaverActivity")), 0)).setSmallIcon(R.drawable.notif).setShowWhen(true).setVibrate(new long[]{(long) 100, (long) 100, (long) 100, (long) 100}).setColor(ContextCompat.getColor(this, R.color.colorAccent));
            this.notif = notification.getNotification();
            Notification notification = this.notif;
            notification.flags |= 8;
