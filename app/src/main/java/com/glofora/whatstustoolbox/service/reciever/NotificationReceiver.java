package com.glofora.whatstustoolbox.service.reciever;
...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public class TransferAll extends AsyncTask<Void, String, Boolean> {
        ...
        protected void onPostExecute(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                ...
                try {
                    activity = PendingIntent.getActivity(this.context, 4896, new Intent(this.context, Class.forName("com.glofora.whatstustoolbox.StatusSaverActivity")), 0);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (stringExtra.equals("openApp")) {
            ...
            closePanel(context);
            try {
                Intent intent2 = new Intent(context, Class.forName("com.glofora.whatstustoolbox.StatusSaverActivity"));
